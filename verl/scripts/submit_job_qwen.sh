...
# 任务名与输出目录
export PROJECT_NAME="qwen3_8b_grounding_rl"
...
export RAY_ADDRESS=33.180.161.122:26379
...
ray job submit --address="${RAY_ADDRESS}" \
  ...
  data.train_files=/storage/openpsi/data/grounding_sft_v1_preprocessed/train_grounding_qwen8bcot_82K \
  ...
  actor_rollout_ref.model.path=/storage/openpsi/models/qwen3_8b_thinking_grounding_sft_4450itr \
