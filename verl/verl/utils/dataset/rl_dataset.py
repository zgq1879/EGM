...
class RLHFDataset(Dataset):
                ...
                def doc2len(doc) -> int:
                    try:
                        ...
                        if image_key in doc and doc[image_key]:
                            images = [
                                process_image({"image":image}, image_patch_size=self.image_patch_size) for image in doc[image_key]
                            ]
                        else:
                            images = None
    ...
    def __getitem__(self, item):
        ...
        if self.processor is not None:
            ...
            if row_dict_images:
                images = [process_image({"image":image}, image_patch_size=self.image_patch_size) for image in row_dict_images]
