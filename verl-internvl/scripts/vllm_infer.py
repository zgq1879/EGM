...
def parse_args():
    ...
    ap.add_argument("--data_json", required=True, help="COCO2014 train 风格 JSON 文件路径")
    ap.add_argument("--endpoint", default="http://127.0.0.1:8000", help="vLLM OpenAI 服务地址（不含 /v1）")
    ap.add_argument("--model", required=True, help="vLLM 服务端加载的模型名称")
